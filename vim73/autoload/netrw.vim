...
if !has('win32') && !has('win64')
 if !executable(g:netrw_localmkdir)
  call netrw#ErrorMsg(s:NOTE,"consider setting g:netrw_localmkdir<".g:netrw_localmkdir."> to something that works:80",80)
 endif
endif
...
if !exists("g:netrw_localmovecmd")
 ...
 if !has('win32') && !has('win64')
  if !executable(g:netrw_localmkdir)
   call netrw#ErrorMsg(s:NOTE,"consider setting g:netrw_localmkdir<".g:netrw_localmkdir."> to something that works:81",81)
  endif
 endif
endif
